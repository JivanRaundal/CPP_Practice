...
// # Inheriting parent class using private access-specifier :-
// => When we Inherit parent class using private access-specifier of child class, all the members coming from parent class
//    becomes private members of child class.
...
int main()
{
	...
	//obj.disp();		//error
	//obj.z = 22;			//error, bcz z becomes private member of child class & hence not accessible in main()
	//cout<<"\nz = "<<obj.z;
	//obj.print();			//error, print() becomes private in child class
	obj.myfun();
	return 0;
}
